...
---
--- Format to a string
--- print(pprint.pformat(pprint.defaults, {sort_keys = false}))
---
--- See Defaults:
--- PrettyPrint.setup({indent_size = 4, level_width = 12, wrap_string = true, wrap_array = true})
--- PrettyPrint(PrettyPrint.defaults)
--- {
---     depth_limit = false,
---     indent_size = 4,
---     level_width = 12,
...
function pprint.pformat(obj, option, printer)
    ...
    formatter['function'] = function_formatter or nop_formatter
